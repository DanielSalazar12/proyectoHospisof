...
export const fetchUsers = async () => {
  try {
    const res = await axios.get(
      "http://localhost:3000/api/usuario/listartodos",
    );
...
export const fetchValidacionDelete = async (idUser) => {
  try {
    const res = await axios.get(
      `http://localhost:3000/api/usuario/listarPorIdUser/${idUser}`,
    );
...
export const createUser = async (formData) => {
  try {
    const response = await axios.post(
      "http://localhost:3000/api/usuario/nuevo",
      formData,
    );
...
export const updateUser = async (id, formData) => {
  try {
    const response = await axios.put(
      `http://localhost:3000/api/usuario/actualizar/${id}`,
      formData,
    );
    return response.data;
  } catch (error) {
...
export const getUserId = async (id) => {
  try {
    const res = await axios.get(
      `http://localhost:3000/api/usuario/listarPorId/${id}`,
    );
